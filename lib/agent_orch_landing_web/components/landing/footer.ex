defmodule AgentOrchLandingWeb.Landing.Footer do
  ...
  def footer(assigns) do
    ~H"""
    <footer id="footer" class="bg-gray-900 border-t border-gray-800/50">
      <div class="mx-auto max-w-7xl px-6 py-16 lg:px-8">
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div class="mt-4 flex gap-4">
              <a href="https://github.com/agentorch" class="text-gray-500 hover:text-gray-300 transition-colors" aria-label="GitHub">
              ...
              <a href="https://twitter.com/agentorch" class="text-gray-500 hover:text-gray-300 transition-colors" aria-label="Twitter">
              ...
              <a href="https://linkedin.com/company/agentorch" class="text-gray-500 hover:text-gray-300 transition-colors" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul class="mt-4 space-y-3">
              <li><a href="#solution" class="text-sm text-gray-400 hover:text-white transition-colors">Features</a></li>
        ...
        <%!-- Bottom Bar --%>
        <div class="mt-12 border-t border-gray-800/50 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
