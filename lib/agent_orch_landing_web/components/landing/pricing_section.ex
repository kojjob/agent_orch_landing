defmodule AgentOrchLandingWeb.Landing.PricingSection do
  ...
  def pricing_section(assigns) do
    ~H"""
    <section id="pricing" class="px-6 py-20 lg:px-8 bg-gray-50 dark:bg-gray-900/50">
      <div class="mx-auto max-w-5xl">
        ...
        <p class="mt-4 text-center text-gray-500 dark:text-gray-400 text-lg" data-animate="fade-up" data-delay="100">
