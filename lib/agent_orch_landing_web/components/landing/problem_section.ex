      ...
      <div class="mx-auto max-w-5xl">
        <div class="text-center" data-animate="fade-up">
          <span class="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-500/20">
            <span class="w-2 h-2 rounded-full bg-emerald-500 mr-2"></span> The Problem
          </span>
        </div>
        <h2
        ...
        <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div
            class="group rounded-xl bg-white/80 dark:bg-gray-800/50 p-8 ring-1 ring-gray-200 dark:ring-gray-700/50 hover-lift hover-glow"
            data-animate="fade-up"
            data-delay="150"
          >
