    ...
    <section class="px-6 py-24 lg:py-32 lg:px-8 bg-gray-100/60 dark:bg-gray-900/50">
      <div class="mx-auto max-w-5xl">
        ...
        <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div class="group rounded-xl bg-white/80 dark:bg-gray-800/50 p-8 ring-1 ring-gray-200 dark:ring-gray-700/50 hover-lift hover-glow" data-animate="fade-up" data-delay="150">
          ...
          <div class="group rounded-xl bg-white/80 dark:bg-gray-800/50 p-8 ring-1 ring-gray-200 dark:ring-gray-700/50 hover-lift hover-glow" data-animate="fade-up" data-delay="300">
          ...
          <div class="group rounded-xl bg-white/80 dark:bg-gray-800/50 p-8 ring-1 ring-gray-200 dark:ring-gray-700/50 hover-lift hover-glow" data-animate="fade-up" data-delay="450">
