      ...
      <div class="mx-auto max-w-5xl">
        ...
        <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div class="rounded-xl bg-gray-800/50 p-8 ring-1 ring-gray-700/50">
            <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-red-500/10 ring-1 ring-red-500/25">
          ...
          <div class="rounded-xl bg-gray-800/50 p-8 ring-1 ring-gray-700/50">
            <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-amber-500/10 ring-1 ring-amber-500/25">
          ...
          <div class="rounded-xl bg-gray-800/50 p-8 ring-1 ring-gray-700/50">
            <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-lg bg-orange-500/10 ring-1 ring-orange-500/25">
