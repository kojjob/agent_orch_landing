      ...
      <div class="mx-auto max-w-5xl">
        <div class="text-center" data-animate="fade-up">
          <span class="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-500/20">
            <span class="w-2 h-2 rounded-full bg-emerald-500 mr-2"></span> Social Proof
          </span>
        </div>
        <h2
        ...
        <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2">
          ...
          >
            ...
            <div class="mt-4 flex items-center gap-3">
              <div class="h-10 w-10 rounded-full bg-indigo-600/20 flex items-center justify-center text-indigo-600 dark:text-indigo-400 font-bold">
                S
              </div>
              <div>
          ...
          >
            ...
            <div class="mt-4 flex items-center gap-3">
              <div class="h-10 w-10 rounded-full bg-purple-600/20 flex items-center justify-center text-purple-600 dark:text-purple-400 font-bold">
                M
              </div>
              <div>
        ...
        <div class="mt-16 text-center">
          ...
          <div
            class="flex flex-wrap justify-center gap-8 text-gray-400"
            data-animate="fade-in"
            data-delay="200"
          >
            <span class="text-lg font-mono hover-shimmer transition-colors cursor-default">
              LangChain
            </span>
            <span class="text-lg font-mono hover-shimmer transition-colors cursor-default">
              CrewAI
