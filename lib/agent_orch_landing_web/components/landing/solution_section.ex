      ...
      <div class="mx-auto max-w-5xl">
        ...
        <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div class="text-center">
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-indigo-600/10 ring-1 ring-indigo-500/30">
          ...
          <div class="text-center">
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-purple-600/10 ring-1 ring-purple-500/30">
          ...
          <div class="text-center">
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-pink-600/10 ring-1 ring-pink-500/30">
