  ...
  def solution_section(assigns) do
    ...
    <section id="solution" class="px-6 py-20 lg:px-8">
      <div class="mx-auto max-w-5xl">
        <h2 class="text-center text-3xl font-bold tracking-tight sm:text-4xl text-gray-900 dark:text-white" data-animate="fade-up">
        ...
        <div class="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-3">
          <div class="group text-center" data-animate="fade-up" data-delay="150">
            ...
            <h3 class="mt-4 text-xl font-semibold text-gray-900 dark:text-white">Orchestrate</h3>
          ...
          <div class="group text-center" data-animate="fade-up" data-delay="300">
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-purple-600/10 ring-1 ring-purple-500/30 icon-pulse">
              <svg class="h-8 w-8 text-purple-600 dark:text-purple-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </div>
            <h3 class="mt-4 text-xl font-semibold text-gray-900 dark:text-white">Observe</h3>
            <p class="mt-2 text-gray-500 dark:text-gray-400">
          ...
          <div class="group text-center" data-animate="fade-up" data-delay="450">
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-pink-600/10 ring-1 ring-pink-500/30 icon-pulse">
              <svg class="h-8 w-8 text-pink-600 dark:text-pink-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5" />
              </svg>
            </div>
            <h3 class="mt-4 text-xl font-semibold text-gray-900 dark:text-white">Scale</h3>
            <p class="mt-2 text-gray-500 dark:text-gray-400">
