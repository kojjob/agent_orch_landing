defmodule AgentOrchLandingWeb.AboutLive do
  ...
  def mount(_params, _session, socket) do
    {:ok,
     ...
     |> assign(
       :page_description,
       "Learn about the team and mission behind AgentOrch, the AI agent orchestration platform."
     )
      ...
      <div class="pt-16" id="scroll-reveal" phx-hook="ScrollReveal">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div data-animate="slide-left">
                <span class="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-500/20">
                  <span class="w-2 h-2 rounded-full bg-emerald-500 mr-2"></span> Our Mission
                </span>
        ...
        <section class="px-6 py-24 lg:py-32 lg:px-8 bg-gray-100/60 dark:bg-gray-900/50">
          <div class="mx-auto max-w-5xl">
            <div class="text-center" data-animate="fade-up">
              <span class="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-500/20">
                <span class="w-2 h-2 rounded-full bg-emerald-500 mr-2"></span> Our Values
              </span>
              <h2 class="mt-4 font-[Space_Grotesk] text-3xl font-bold tracking-tight">
                What drives us
              </h2>
            ...
            <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div
                class="rounded-2xl bg-white/80 dark:bg-gray-800/50 p-8 ring-1 ring-gray-200 dark:ring-gray-700/50 shadow-sm"
        ...
        <section class="px-6 py-24 lg:py-32 lg:px-8">
          <div class="mx-auto max-w-5xl">
            <div class="text-center" data-animate="fade-up">
              <span class="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-500/20">
                <span class="w-2 h-2 rounded-full bg-emerald-500 mr-2"></span> Our Team
              </span>
              <h2 class="mt-4 font-[Space_Grotesk] text-3xl font-bold tracking-tight">
                Meet the people behind AgentOrch
              </h2>
        ...
        <section class="px-6 py-24 lg:py-32 lg:px-8 bg-gray-100/60 dark:bg-gray-900/50">
          <div class="mx-auto max-w-2xl text-center" data-animate="fade-up">
            ...
            <div class="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/#hero"
                class="rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 px-7 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:brightness-110 active:scale-[0.97] transition-all"
              >
                Join the Waitlist →
              </a>
              <a
                href="/contact"
                class="rounded-full px-7 py-3 text-sm font-semibold text-gray-900 dark:text-white ring-1 ring-gray-300 dark:ring-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all"
              >
                Get in Touch →
              </a>
            </div>
  ...
  defp team_card(assigns) do
    ...
    assigns =
      assign(assigns, :gradient, Map.get(colors, assigns.color, "from-indigo-500 to-indigo-600"))

    ~H"""
    <div
      class="rounded-2xl bg-white/80 dark:bg-gray-800/50 p-6 ring-1 ring-gray-200 dark:ring-gray-700/50 shadow-sm hover:shadow-md transition-shadow"
      data-animate="fade-up"
    >
