defmodule AgentOrchLandingWeb.BlogLive do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     ...
     |> assign(:page_description, "Insights on AI agent orchestration, best practices, and industry trends.")
      ...
      <div class="pt-16" id="scroll-reveal" phx-hook="ScrollReveal">
        ...
        <section class="px-6 py-16 lg:py-24 lg:px-8">
          <div class="mx-auto max-w-4xl">
            <%= if @posts == [] do %>
              <p class="text-center text-gray-500 dark:text-gray-400">No posts yet. Check back soon!</p>
            <% else %>
              <div class="space-y-10">
                <article :for={post <- @posts} class="group rounded-2xl bg-white dark:bg-gray-900 p-8 ring-1 ring-gray-200 dark:ring-gray-800 hover:ring-indigo-500/50 transition-all" data-animate="fade-up">
