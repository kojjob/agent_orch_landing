defmodule AgentOrchLandingWeb.ContactLive do
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok,
     ...
     |> assign(
       :page_description,
       "Get in touch with the AgentOrch team. Questions, partnerships, demos, and support."
     )
    ...
    >
      ...
      <div class="pt-16" id="scroll-reveal" phx-hook="ScrollReveal">
        ...
        <section class="relative overflow-hidden px-6 py-32 sm:py-40 lg:px-8">
          <div class="absolute inset-0 bg-gradient-to-br from-purple-50 via-gray-50 to-indigo-50 dark:from-purple-950 dark:via-gray-950 dark:to-indigo-950">
          </div>
                ...
                <div class="space-y-6">
                  ...
                  <div class="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:hello@agentorch.dev"
                  ...
                  <div class="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div class="mt-1 flex gap-3">
                        <a
                          href="https://github.com/agentorch"
                        ...
                        <a
                          href="https://twitter.com/agentorch"
                          class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
                          aria-label="Twitter"
                        >
                          <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <a
                          href="https://linkedin.com/company/agentorch"
                          class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
                          aria-label="LinkedIn"
                        >
                          <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option
                            value="general"
                            selected={@contact_form[:subject].value == "general"}
                          >
                            General Inquiry
                          </option>
                          <option value="demo" selected={@contact_form[:subject].value == "demo"}>
                            Request a Demo
                          </option>
                          <option
                            value="partnership"
                            selected={@contact_form[:subject].value == "partnership"}
                          >
                            Partnership
                          </option>
                          <option
                            value="enterprise"
                            selected={@contact_form[:subject].value == "enterprise"}
                          >
                            Enterprise Plan
                          </option>
                          <option
                            value="support"
                            selected={@contact_form[:subject].value == "support"}
                          >
                            Technical Support
                          </option>
                          <option value="press" selected={@contact_form[:subject].value == "press"}>
                            Press & Media
                          </option>
                        </select>
                      ...
                      <button
                        type="submit"
                        class="w-full rounded-full bg-gradient-to-r from-indigo-600 to-purple-600 px-7 py-3 text-sm font-semibold text-white shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/40 hover:brightness-110 active:scale-[0.97] transition-all"
                      >
                        Send Message →
                      </button>
                    </.form>
          ...
          <div class="mx-auto max-w-3xl">
            <div class="text-center" data-animate="fade-up">
              <span class="inline-flex items-center rounded-full bg-emerald-500/10 px-3 py-1 text-xs font-medium text-emerald-600 dark:text-emerald-400 ring-1 ring-emerald-500/20">
                <span class="w-2 h-2 rounded-full bg-emerald-500 mr-2"></span> FAQ
              </span>
  ...
  defp faq_item(assigns) do
    ~H"""
    <div
      class="rounded-2xl bg-white/80 dark:bg-gray-800/50 p-6 ring-1 ring-gray-200 dark:ring-gray-700/50"
